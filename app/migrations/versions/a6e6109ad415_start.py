...
Revision ID: a6e6109ad415
Revises: 
Create Date: 2026-07-26 22:11:47.037786
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('status', sa.Enum('PLANNED', 'CANCELED', 'COMPLETED', 'IN_PROGRESS', name='meetingstatusenum'), nullable=False),
    ...
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=False),
    sa.Column('status', sa.Enum('CREATE', 'OPEN', 'IN_PROGRESS', 'COMPLETED', name='taskstatus'), nullable=False),
